...
def main():
    ...
    def calculate_min_area_rect_angle(points):
        # Convert points to a cv2 contour
        contour = np.array(points, dtype=np.float32)

        #### Get the rotation angle from the box
    ...
    def preprocess_train(examples):            
        ...
        for image in examples[image_column]:
            ...
            for line in ocrs:
                ...
                #### calculate the angle information here                
                angle = calculate_min_area_rect_angle([(x1,y1),(x2,y2),(x3,y3),(x4,y4)])
                ...
                x_center = (x_min + x_max) // 2
                y_center = (y_min + y_max) // 2
                ocrs_temp.append([x_center, y_center, x_min, y_min, x_max, y_max, pred, angle]) #### additionally append the angle information
            ...
            for line in ocrs_temp:
                ...
                x_center, y_center, x_min, y_min, x_max, y_max, pred, angle = line
                ...
                if args.coord_mode == 'lt':
                    ...
                    ocr_ids.extend(['l'+str(x_left), 't'+str(y_top), 'r'+str(x_right), 'b'+str(y_bottom), 'a'+str(angle)])
