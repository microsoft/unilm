...
| SpeechLM-P Base   | [960 hrs LibriSpeech](http://www.openslr.org/12) + [40M Text](http://www.openslr.org/11)                      | [En-De CoVoST-2](https://github.com/facebookresearch/covost)      | [OneDrive](https://1drv.ms/u/s!AqeByhGUtINrgcp77neaBzVfHzStXQ?e=Ukpgqn)  |
| SpeechLM-P Base   | [960 hrs LibriSpeech](http://www.openslr.org/12) + [40M Text](http://www.openslr.org/11)                      | [En-Ca CoVoST-2](https://github.com/facebookresearch/covost)      | [OneDrive](https://1drv.ms/u/s!AqeByhGUtINrgcp6tpL19Q6-wC31QA?e=fC6Kta)  |
| SpeechLM-P Base   | [960 hrs LibriSpeech](http://www.openslr.org/12) + [40M Text](http://www.openslr.org/11)                      | [En-Ar CoVoST-2](https://github.com/facebookresearch/covost)      | [OneDrive](https://1drv.ms/u/s!AqeByhGUtINrgcp-iEXI9A1ajeAqrg?e=it7j6w)  |
| SpeechLM-P Base   | [960 hrs LibriSpeech](http://www.openslr.org/12) + [40M Text](http://www.openslr.org/11)                      | [En-Tr CoVoST-2](https://github.com/facebookresearch/covost)      | [OneDrive](https://1drv.ms/u/s!AqeByhGUtINrgcp8WcrRMxOhcFpN2w?e=JBhYVX)  |
...
For easier use of our pre-trained models, we merge all inference-related code to [`SpeechLM.py`](SpeechLM.py) and make cleaned checkpoints [`SpeechLM-P Base`](https://1drv.ms/u/s!AqeByhGUtINrgcsIvZ8m1B7jrCZUVQ?e=fhGtzu) [`SpeechLM-H Base`](https://1drv.ms/u/s!AqeByhGUtINrgcsH8Wf6vR_pzfjoaQ?e=PgLWsS) [`SpeechLM-P Large`](https://1drv.ms/u/s!AqeByhGUtINrgcsFdbjgcEuDhwN3vg?e=EF3usb) by removing non-required modules. Now you can directly use the following script to extract your speech features:
```python
import torch
