...
(2) According to your decisions to each of the segment, decide if the composed one, i.e., the overall solution, can well solve the problem with the given test cases, time and memory limits.
