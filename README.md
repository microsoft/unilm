...
- [x] [**s2s-ft 1.0**](https://github.com/microsoft/unilm/tree/master/s2s-ft) (February 26, 2020): a PyTorch package for fine-tuning pre-trained Transformers for sequence-to-sequence language generation tasks. "[Fine-Tuning Bidirectional Transformers for Sequence-to-Sequence Learning](#)"
