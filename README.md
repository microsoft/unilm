...
> [**InfoXLM**](https://github.com/microsoft/unilm/tree/master/infoxlm) (```v2@NAACL'21```): **multilingual/cross-lingual pre-trained models for language understanding and generation**
