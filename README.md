...
**Unified pre-training across tasks (understanding, generation and translation), languages, and modalities**
...
> [**DeltaLM**](https://github.com/microsoft/unilm/tree/master/deltalm) (```NEW```)
