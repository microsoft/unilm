...
> [**VLMo**](https://github.com/microsoft/unilm/tree/master/vlmo) (```NEW```): Unified vision-language pre-training - an evolution of **BEiT** to multimodal 
...
## News
- [Model Release] November, 2021: [**VLMo**](https://github.com/microsoft/unilm/tree/master/vlmo) - Unified vision-language pre-training w/ pre-trained [**BEiT**](https://github.com/microsoft/unilm/tree/master/beit)  
...
For other communications related to UniLM AI, please contact [Furu Wei](http://gitnlp.org/) (`fuwei@microsoft.com`).
