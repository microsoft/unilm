...
**Pre-trained (foundation) models across tasks (understanding, generation and translation), languages (100+ languages), and modalities (language, image, adudio, vision + language, audio + language, etc.)**
